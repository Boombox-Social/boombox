        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg border border-[#2D3142] bg-[#181A20]"
            >
          ...
          <div className="flex justify-end gap-3 mt-6">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2 bg-[#2D3142] rounded-lg font-medium hover:bg-[#374151] transition-colors"
              disabled={isLoading}
            >
              Cancel
            </button>
