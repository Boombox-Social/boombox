    ...
    return (
      <div className="flex justify-center gap-2 mt-5">
        <input
          ...
          className="px-5 py-2 rounded-lg border border-border text-base w-full max-w-full min-w-[80px] focus:outline-none"
          autoFocus
          placeholder="Enter Overview link"
        />
        <button
          className="bg-[#2563eb] text-[#F1F5F9] border border-border rounded-lg px-2 py-2 text-lg cursor-pointer transition-colors flex items-center min-w-[40px] justify-center"
          onClick={handleSave}
